# Generated by Django 5.2.4 on 2025-07-04 11:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coins', models.PositiveBigIntegerField(blank=True, default=25000, null=True, verbose_name='coins')),
                ('otp', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='otp')),
            ...
            managers=[
                ('objects', custom_auth.managers.ApplicationUserManager()),
            ],
        ),
    ]
